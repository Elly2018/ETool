...
{
    [NodePath("Add Node/Array/Insert Element")]
    public class InsertElement : NodeBase
    {
        private object elementBuffer;
        private object[] elementArrayBuffer;

        public InsertElement(Vector2 position, float width, float height) : base(position, width, height)
        {
