...
{
    [NodePath("Add Node/Array/Method/RemoveElementAt")]
    public class ArrayRemoveElementAt : NodeBase
    {
        object[] dataBuffer;

        public ArrayRemoveElementAt(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Remove Element At";
        }
