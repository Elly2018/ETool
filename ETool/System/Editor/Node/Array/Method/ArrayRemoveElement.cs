...
{
    [NodePath("Add Node/Array/Method/RemoveElement")]
    public class ArrayRemoveElement : NodeBase
    {
        private object elementBuffer;
        private object[] elementArrayBuffer;

        public ArrayRemoveElement(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Remove Element";
        }
