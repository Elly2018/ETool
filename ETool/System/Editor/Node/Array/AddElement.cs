...
{
    [NodePath("Add Node/Array/Add Element")]
    public class AddElement : NodeBase
    {
        private object elementBuffer;
        private object[] elementArrayBuffer;

        public AddElement(Vector2 position, float width, float height) : base(position, width, height)
        {
            title = "Add Element";
        }
