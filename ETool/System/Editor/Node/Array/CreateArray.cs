...
{
    [NodePath("Add Node/Array/Create Array")]
    public class CreateArray : NodeBase
    {
        public CreateArray(Vector2 position, float width, float height) : base(position, width, height)
        {
            title = "Create Array";
        }
