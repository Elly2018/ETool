...
{
    [NodePath("Add Node/Physics/AddRelativeTorque")]
    public class AddRelativeTorque : NodeBase
    {
        public AddRelativeTorque(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "AddRelativeTorque";
        }
