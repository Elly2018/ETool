...
{
    [NodePath("Add Node/Math/Vector/VectorSqrMagnitude")]
    [Math_Menu("Vector")]
    public class VectorSqrMagnitude : NodeBase
    {
        public VectorSqrMagnitude(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Vector SqrMagnitude";
        }
        ...
        public float GetResultVector2(BlueprintInput data)
        {
            ...
            switch (ft)
            {
                case FieldType.Vector2:
                    return GetFieldOrLastInputField<Vector2>(2, data).sqrMagnitude;
                case FieldType.Vector3:
                    return GetFieldOrLastInputField<Vector3>(2, data).sqrMagnitude;
                case FieldType.Vector4:
                    return GetFieldOrLastInputField<Vector4>(2, data).sqrMagnitude;
            }
            return GetFieldOrLastInputField<Vector2>(2, data).sqrMagnitude;
        }
    }
