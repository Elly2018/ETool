...
{
    [NodePath("Add Node/Math/Basic/AddingNumber")]
    public class MathAddNumber : NodeBase
    {
        public MathAddNumber(Vector2 position, float width, float height) : base(position, width, height)
        {
