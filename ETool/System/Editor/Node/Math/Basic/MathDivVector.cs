...
{
    [NodePath("Add Node/Math/Basic/DivideVector")]
    public class MathDivVector : NodeBase
    {
        public MathDivVector(Vector2 position, float width, float height) : base(position, width, height)
        {
