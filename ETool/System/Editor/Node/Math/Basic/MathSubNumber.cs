...
{
    [NodePath("Add Node/Math/Basic/SubtractNumber")]
    public class MathSubNumber : NodeBase
    {
        public MathSubNumber(Vector2 position, float width, float height) : base(position, width, height)
        {
