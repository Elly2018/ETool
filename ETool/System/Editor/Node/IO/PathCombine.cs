...
{
    [NodePath("Add Node/IO/Path Combine")]
    public class PathCombine : NodeBase
    {
        public PathCombine(Vector2 position, float width, float height) : base(position, width, height)
        {
            title = "Path Combine";
        }
