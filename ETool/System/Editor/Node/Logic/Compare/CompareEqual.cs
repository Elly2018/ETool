...
{
    [NodePath("Add Node/Logic/Compare/Equal")]
    public class CompareEqual : NodeBase
    {
        public CompareEqual(Vector2 position, float width, float height) : base(position, width, height)
        {
