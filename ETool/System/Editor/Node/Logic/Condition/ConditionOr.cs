...
{
    [NodePath("Add Node/Logic/Condition/Or")]
    public class ConditionOr : NodeBase
    {
        public ConditionOr(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Or";
        }
