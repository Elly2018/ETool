...
{
    [NodePath("Add Node/Logic/Gate/NOR")]
    [Logic_Menu("Gate")]
    public class ConditionNOR : NodeBase
    {
        public ConditionNOR(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "NOR";
        }
