...
{
    [NodePath("Add Node/Character/Get/GetMinMoveDistance")]
    public class CharacterGetMinMoveDistance : NodeBase
    {
        public CharacterGetMinMoveDistance(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Get Character Min Move Distance";
        }
        ...
        {
            return GetFieldOrLastInputField<CharacterController>(1, data).minMoveDistance;
        }
    }
}
