...
{
    [NodePath("Add Node/Character/Get/GetRadius")]
    public class CharacterGetRadius : NodeBase
    {
        public CharacterGetRadius(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Get Character Radius";
        }
        ...
        {
            return GetFieldOrLastInputField<CharacterController>(1, data).radius;
        }
    }
}
