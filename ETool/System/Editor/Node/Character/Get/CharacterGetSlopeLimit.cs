...
{
    [NodePath("Add Node/Character/Get/GetSlopeLimit")]
    public class CharacterGetSlopeLimit : NodeBase
    {
        public CharacterGetSlopeLimit(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Get Character Slope Limit";
        }
        ...
        {
            return GetFieldOrLastInputField<CharacterController>(1, data).slopeLimit;
        }
    }
}
