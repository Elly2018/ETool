...
{
    [NodePath("Add Node/Character/Get/GetStepOffset")]
    public class CharacterGetStepOffset : NodeBase
    {
        public CharacterGetStepOffset(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Get Character Step Offset";
        }
        ...
        {
            return GetFieldOrLastInputField<CharacterController>(1, data).stepOffset;
        }
    }
}
