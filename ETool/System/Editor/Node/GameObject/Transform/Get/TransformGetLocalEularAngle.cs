...
{
    [NodePath("Add Node/GameObject/Transform/Get/GetLocalEularAngle")]
    public class TransformGetLocalEularAngle : NodeBase
    {
        public TransformGetLocalEularAngle(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Get Local EularAngle";
        }
