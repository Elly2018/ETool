...
{
    [NodePath("Add Node/Transform/Translate")]
    public class Translate : NodeBase
    {
        public Translate(Vector2 position, float width, float height) : base(position, width, height)
        {
            title = "Translate";
        }
