...
{
    [NodePath("Add Node/Render/Camera/Get/GetFarClipPlane")]
    public class CameraGetFarClipPlane : NodeBase
    {
        public CameraGetFarClipPlane(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Get Camera Far Clip Plane";
        }
        ...
        {
            return GetFieldOrLastInputField<Camera>(1, data).farClipPlane;
        }
    }
}
