...
{
    [NodePath("Add Node/Render/Camera/Get/GetDepth")]
    public class CameraGetDepth : NodeBase
    {
        public CameraGetDepth(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Get Camera Depth";
        }
        ...
        {
            return GetFieldOrLastInputField<Camera>(1, data).depth;
        }
    }
}
