...
{
    [NodePath("Add Node/Render/Camera/Method/ResetAspect")]
    public class CameraResetAspect : NodeBase
    {
        public CameraResetAspect(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Camera Reset Aspect";
        }
        ...
        {
            GetFieldOrLastInputField<Camera>(1, data).ResetAspect();
        }
