...
{
    [NodePath("Add Node/Render/Camera/Method/RenderDontRestore")]
    public class CameraRenderDontRestore : NodeBase
    {
        public CameraRenderDontRestore(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Camera Render Dont Restore";
        }
