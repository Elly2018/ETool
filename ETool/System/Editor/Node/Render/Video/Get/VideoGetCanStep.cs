...
{
    [NodePath("Add Node/Render/Video/Get/GetCanStep")]
    public class VideoGetCanStep : NodeBase
    {
        public VideoGetCanStep(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Can Step";
        }
        ...
        {
            return GetFieldOrLastInputField<VideoPlayer>(1, data).canStep;
        }
