...
{
    [NodePath("Add Node/Render/Video/Get/GetCanSetTime")]
    public class VideoGetCanSetTime : NodeBase
    {
        public VideoGetCanSetTime(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Can Set Time";
        }
        ...
        {
            return GetFieldOrLastInputField<VideoPlayer>(1, data).canSetTime;
        }
