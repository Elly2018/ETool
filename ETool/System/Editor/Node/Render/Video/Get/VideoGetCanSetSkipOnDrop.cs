...
{
    [NodePath("Add Node/Render/Video/Get/GetCanSetSkipOnDrop")]
    public class VideoGetCanSetSkipOnDrop : NodeBase
    {
        public VideoGetCanSetSkipOnDrop(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Can Set Skip On Drop";
        }
        ...
        {
            return GetFieldOrLastInputField<VideoPlayer>(1, data).canSetSkipOnDrop;
        }
