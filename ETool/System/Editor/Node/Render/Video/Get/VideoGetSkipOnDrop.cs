...
{
    [NodePath("Add Node/Render/Video/Get/GetSkipOnDrop")]
    public class VideoGetSkipOnDrop : NodeBase
    {
        public VideoGetSkipOnDrop(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Get SkipOnDrop";
        }
        ...
        {
            return GetFieldOrLastInputField<VideoPlayer>(1, data).skipOnDrop;
        }
