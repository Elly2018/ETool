...
{
    [NodePath("Add Node/Render/Video/Method/Play")]
    public class VideoPlay : NodeBase
    {
        public VideoPlay(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Video Play";
        }

        public override void ProcessCalling(BlueprintInput data)
        {
            GetFieldOrLastInputField<VideoPlayer>(1, data).Play();
