...
{
    [NodePath("Add Node/Render/Video/Set/SetPlayOnAwake")]
    public class VideoSetPlayOnAwake : NodeBase
    {
        public VideoSetPlayOnAwake(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Set PlayOnAwake";
        }

        public override void ProcessCalling(BlueprintInput data)
        {
            GetFieldOrLastInputField<VideoPlayer>(1, data).playOnAwake = GetFieldOrLastInputField<bool>(2, data);
