...
{
    [NodePath("Add Node/Render/Material/Set/SetMainTextureScale")]
    public class MaterialSetMainTextureScale : NodeBase
    {
        public MaterialSetMainTextureScale(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Material Set Main Texture Scale";
        }
