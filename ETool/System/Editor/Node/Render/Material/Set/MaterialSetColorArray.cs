...
{
    [NodePath("Add Node/Render/Material/Set/SetColorArray")]
    public class MaterialSetColorArray : NodeBase
    {
        public MaterialSetColorArray(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Material Set Color Array";
        }
        ...
        public override void FieldInitialize()
        {
            ...
            fields.Add(new Field(FieldType.Color, "Color", ConnectionType.DataInput, this, FieldContainer.Array));
        }
        ...
        public override void ProcessCalling(BlueprintInput data)
        {
            ...
            if ((bool)fields[2].GetValue(FieldType.Boolean))
            {
                ...
                if (mat != null)
                    mat.SetColorArray(id, color);
            }
            else
            {
                string name = GetFieldOrLastInputField<string>(3, data);
                if (mat != null)
                    mat.SetColorArray(name, color);
            }
