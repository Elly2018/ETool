...
{
    [NodePath("Add Node/Render/Light/Set/SetRange")]
    public class LightSetRange : NodeBase
    {
        public LightSetRange(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Set Light Range";
        }
