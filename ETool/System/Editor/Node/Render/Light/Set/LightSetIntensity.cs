...
{
    [NodePath("Add Node/Render/Light/Set/SetIntensity")]
    public class LightSetIntensity : NodeBase
    {
        public LightSetIntensity(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Set Light Intensity";
        }
