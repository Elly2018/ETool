...
{
    [NodePath("Add Node/Animator/Set/SetIKPositionWeight")]
    public class AnimatorSetIKPositionWeight : NodeBase
    {
        public AnimatorSetIKPositionWeight(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Set IK Position Weight";
        }
