...
{
    [NodePath("Add Node/Animator/Get/GetInt")]
    public class AnimatorGetInt : NodeBase
    {
        public AnimatorGetInt(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Get Int";
        }
