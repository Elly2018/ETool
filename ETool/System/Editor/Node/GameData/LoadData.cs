...
{
    [NodePath("Add Node/GameData/Load GameData")]
    public class LoadData : NodeBase
    {
        private EGameData gamedataBuffer;

        public LoadData(Vector2 position, float width, float height) : base(position, width, height)
        {
            title = "Load GameData";
        }
