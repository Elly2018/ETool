...
{
    [NodePath("Add Node/GameData/Method/SaveGameData")]
    public class GameDataSaveData : NodeBase
    {
        public GameDataSaveData(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Save GameData";
        }
