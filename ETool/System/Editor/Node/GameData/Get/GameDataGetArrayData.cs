...
{
    [NodePath("Add Node/GameData/Get/GetArrayData")]
    public class GameDataGetArrayData : NodeBase
    {
        public GameDataGetArrayData(Vector2 position, float width, float height) : base(position, width, height)
        {
            unlocalTitle = "Get Array Data";
        }
        ...
        public object[] GetResult(BlueprintInput data)
        {
            ...
            if (target != null)
            {
                ...
                return target.GetArrayData(v1, v2, v3);
            }
        ...
        private void UpdateFieldType()
        {
            ...
            {
                fields[4] = new Field(ty, "Value", ConnectionType.DataOutput, true, this, FieldContainer.Array);
            }
        }
    }
}
